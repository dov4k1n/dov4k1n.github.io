...
footer.innerHTML = `
  ...
  <div class="social-networks">
    <div class="social-networks-item">
      <a href="https://www.t.me/tatar_app" class="social-networks-item-logo"><img src="/res/tg_icon.svg" class="logo">Telegram</img></a>
      Подписывайтесь на @tatar_app в Telegram
    </div>
    <div class="social-networks-item">
      <a href="https://www.youtube.com/@tatarcham" class="social-networks-item-logo"><img src="/res/yt_icon.webp" class="logo">YouTube</img></a>
  ...
  <div class="ios-waitlist">
    <div class="social-networks-item">
      <a href="https://www.t.me/tatar_app" class="social-networks-item-logo"><img src="/res/android_icon.svg" class="logo">Android</img></a>
      Скачайте приложение на Android
    </div>

    <div class="social-networks-item">
      <a href="https://www.t.me/tatarcham_ios" class="social-networks-item-logo"><img src="/res/apple_icon.svg" class="logo">iOS</img></a>
